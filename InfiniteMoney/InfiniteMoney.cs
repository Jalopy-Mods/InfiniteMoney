...
namespace InfiniteMoney
{
    public class InfiniteMoney : Mod
    {
        ...
        public override string ModVersion => "1.1"; // The mod's version. Also shown in the mods list. If your mod is open-source on GitHub, make sure that you're using the same format as your release tags (for example, 1.0.0)
